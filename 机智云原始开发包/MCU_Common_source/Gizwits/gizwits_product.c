...
void userHandle(void)
{
    ...
    currentDataPoint.valueMQ135 = g_PM25;//Add Sensor Data Collection
    currentDataPoint.valueMQ2 = g_MQ2;//Add Sensor Data Collection
    currentDataPoint.valuePM25 = g_MQ135;//Add Sensor Data Collection
}
...
void userInit(void)
{
    ...
    currentDataPoint.valueMQ135 = 0;
    currentDataPoint.valueMQ2 = 0;
