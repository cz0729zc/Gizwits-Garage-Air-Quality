...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    devStatusPtr->valueMQ135 = exchangeWord(gizY2XFloat(MQ135_RATIO,  MQ135_ADDITION, dataPoints->valueMQ135)); 
    devStatusPtr->valueMQ2 = exchangeWord(gizY2XFloat(MQ2_RATIO,  MQ2_ADDITION, dataPoints->valueMQ2)); 
    devStatusPtr->valuePM25 = exchangeWord(gizY2XFloat(PM25_RATIO,  PM25_ADDITION, dataPoints->valuePM25)); 
